...
Module dwf
    ...
    '
    Public Const DECIAnalogInChannelCount As Byte   = 1
    Public Const DECIAnalogOutChannelCount As Byte   = 2
    Public Const DECIAnalogIOChannelCount As Byte   = 3
    Public Const DECIDigitalInChannelCount As Byte   = 4
    Public Const DECIDigitalOutChannelCount As Byte   = 5
    Public Const DECIDigitalIOChannelCount As Byte   = 6
    Public Const DECIAnalogInBufferSize As Byte   = 7
    Public Const DECIAnalogOutBufferSize As Byte   = 8
    Public Const DECIDigitalInBufferSize As Byte   = 9
    Public Const DECIDigitalOutBufferSize As Byte   = 10

    ' acquisition modes:
    Public Const acqmodeSingle As Byte       = 0
    Public Const acqmodeScanShift As Byte    = 1
    Public Const acqmodeScanScreen As Byte   = 2
    Public Const acqmodeRecord As Byte       = 3
    Public Const acqmodeOvers As Byte        = 4
    Public Const acqmodeSingle1 As Byte      = 5

    ' analog acquisition filter:
    Public Const filterDecimate As Byte   = 0
    Public Const filterAverage As Byte    = 1
    Public Const filterMinMax As Byte     = 2

    ' analog in trigger mode:
    Public Const trigtypeEdge As Byte           = 0
    Public Const trigtypePulse As Byte          = 1
    Public Const trigtypeTransition As Byte     = 2

    ' trigger slope:
    Public Const DwfTriggerSlopeRise As Byte     = 0
    Public Const DwfTriggerSlopeFall As Byte     = 1
    Public Const DwfTriggerSlopeEither As Byte   = 2
    ...
    Public Const AnalogOutNodeCarrier As Byte = 0
    Public Const AnalogOutNodeFM As Byte = 1
    Public Const AnalogOutNodeAM As Byte = 2

    Public Const DwfAnalogOutModeVoltage As Byte = 0
    Public Const DwfAnalogOutModeCurrent As Byte = 1

    Public Const DwfAnalogOutIdleDisable As Byte = 0
    Public Const DwfAnalogOutIdleOffset As Byte = 1
    Public Const DwfAnalogOutIdleInitial As Byte = 2

    Public Const DwfDigitalInClockSourceInternal As Byte = 0
    Public Const DwfDigitalInClockSourceExternal As Byte = 1

    Public Const DwfDigitalInSampleModeSimple As Byte = 0
    ' alternate samples: noise|sample|noise|sample|...  
    ' where noise is more than 1 transition between 2 samples
    Public Const DwfDigitalInSampleModeNoise As Byte = 1

    Public Const DwfDigitalOutOutputPushPull As Byte = 0
    Public Const DwfDigitalOutOutputOpenDrain As Byte = 1
    Public Const DwfDigitalOutOutputOpenSource As Byte = 2
    Public Const DwfDigitalOutOutputThreeState As Byte = 3 ' for custom and random

    Public Const DwfDigitalOutTypePulse As Byte = 0
    Public Const DwfDigitalOutTypeCustom As Byte = 1
    Public Const DwfDigitalOutTypeRandom As Byte = 2
    Public Const DwfDigitalOutTypeROM As Byte = 3
    Public Const DwfDigitalOutTypeFSM As Byte = 3

    Public Const DwfDigitalOutIdleInit As Byte = 0
    Public Const DwfDigitalOutIdleLow As Byte = 1
    Public Const DwfDigitalOutIdleHigh As Byte = 2
    Public Const DwfDigitalOutIdleZet As Byte = 3

    Public Const DwfAnalogImpedanceImpedance As Byte = 0 ' Ohms
    Public Const DwfAnalogImpedanceImpedancePhase As Byte = 1 ' Radians
    Public Const DwfAnalogImpedanceResistance As Byte = 2 ' Ohms
    Public Const DwfAnalogImpedanceReactance As Byte = 3 ' Ohms
    Public Const DwfAnalogImpedanceAdmittance As Byte = 4 ' Siemen
    Public Const DwfAnalogImpedanceAdmittancePhase As Byte = 5 ' Radians
    Public Const DwfAnalogImpedanceConductance As Byte = 6 ' Siemen
    Public Const DwfAnalogImpedanceSusceptance As Byte = 7 ' Siemen
    Public Const DwfAnalogImpedanceSeriesCapactance As Byte = 8 ' Farad
    Public Const DwfAnalogImpedanceParallelCapacitance As Byte = 9 ' Farad
    Public Const DwfAnalogImpedanceSeriesInductance As Byte = 10 ' Henry
    Public Const DwfAnalogImpedanceParallelInductance As Byte = 11 ' Henry
    Public Const DwfAnalogImpedanceDissipation As Byte = 12 ' factor
    Public Const DwfAnalogImpedanceQuality As Byte = 13 ' factor

    Public Const DwfParamUsbPower As Byte = 2 ' 1 keep the USB power enabled even when AUX is connected, Analog Discovery 2
    Public Const DwfParamLedBrightness As Byte = 3 ' LED brightness 0 ... 100%, Digital Discovery
    Public Const DwfParamOnClose As Byte = 4 ' 0 continue, 1 stop, 2 shutdown
    Public Const DwfParamAudioOut As Byte = 5 ' 0 disable / 1 enable audio output, Analog Discovery 1, 2
    Public Const DwfParamUsbLimit As Byte = 6 ' 0..1000 mA USB power limit, -1 no limit, Analog Discovery 1, 2
